        ...
        <div className=" flex gap-[100px] mb-[150px] mt-[100px] items-center">
            ...
            <div className=" bg-white p-[50px] rounded-[12px] flex flex-col gap-[50px] w-[1300px]">
                <div className="w-full flex flex-col items-center">
                    <h1 className='font-sans font-[600] text-[48px] leading-[60.72px]'>Login</h1>
                    <p className='font-sans font-[400] text-[18px] leading-[22.77px] text-center'>Welcome back! Please log in to access your account.</p>
                </div>
                <div className=" flex flex-col gap-[30px]">
                    <div className="flex flex-col gap-[24px]">
                        ...
                        <div className="flex gap-[10px]">
                            ...
                            <p className='font-sans font-[400] text-[16px] leading-[24px] text-[#59595a]'>Remember Me</p>
                        </div>
                        <button className='py-[18px] px-[20px] bg-[#ff9500] rounded-[10px] text-white font-sans font-[500] text-[18px] leading-[27px] '>Login</button>
                    </div>
                    ...
                    <button className='py-[20px] px-[24px] border rounded-[10px] flex items-center gap-[14px] justify-center font-sans font-[500] text-[18px] leading-[27px] bg-[#f7f7f8]'><img src={google} alt="" />Login with Google</button>
                    <div className="flex justify-center items-center gap-[6px]">
                        <p className=' font-sans font-[500] text-[18px] leading-[27px]'>Don’t have an account? <span className='border-b border-[#262626]'><NavLink to={'/signup'}>Sign Up</NavLink></span></p>
                        <img src={vector} alt="" />
                    </div>
                </div>
            </div>
